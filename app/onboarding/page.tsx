...
/* ─── Focus Options ─── */
const focusOptions = [
  { value: "love", label: "Love", icon: Heart, color: "#D66BFF" },
  { value: "compatibility", label: "Compatibility", icon: Star, color: "#8B5CFF" },
  { value: "self-discovery", label: "Self-Discovery", icon: Compass, color: "#B69CFF" },
  { value: "career", label: "Career", icon: Briefcase, color: "#4BC8FF" },
  { value: "daily", label: "Daily Guidance", icon: Sun, color: "#FFB86D" },
]
...
function FocusSelect({
  ...
  const selected = focusOptions.find((o) => o.value === value)
    ...
    <div ref={ref} className="relative">
      ...
      >
        {selected ? (
          ...
          <span className="text-muted-foreground">Select your main focus...</span>
        )}
        <ChevronDown
                ...
                >
                  <div className="mb-6">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                      Enter your birth details so your AI agents can personalize
                      your readings.
                    </p>
                  </div>
              ...
              {step === 2 && (
                ...
                >
                  <div className="mb-6">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                      Your birth data powers accurate chart calculations for
                  ...
                  <div className="space-y-5">
                    ...
                    <FormField
                      ...
                      icon={Clock}
                      type="time"
                      placeholder="Enter your birth time (optional)"
                      value={birthTime}
              ...
              {step === 3 && (
                ...
                >
                  <div className="mb-6">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                      Choose your main focus so we can match you with the right
                      AI agent.
                    </p>
                  </div>
