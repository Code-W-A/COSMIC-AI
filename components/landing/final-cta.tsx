        ...
        >
          <div className="glass-strong rounded-3xl p-12 md:p-16 glow-primary">
            ...
            <h2 className="text-3xl font-bold text-[#F5F2FF] text-balance sm:text-4xl lg:text-5xl">
              {isRo ? "Începe o conversație cu" : "Start a conversation with your"}{" "}
              <span className="text-gradient-cosmic">{isRo ? "AI cosmic" : "cosmic AI"}</span>{" "}
              {isRo ? "astăzi" : "today"}
            </h2>

            <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-[#B8B2D9] text-pretty">
              {isRo
                ? "Descoperă o metodă mai personală de a explora iubirea, scopul, compatibilitatea și autocunoașterea."
