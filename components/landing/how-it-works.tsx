    ...
    ? [
        {
          number: "01",
          icon: User,
          title: "Creezi profilul cosmic",
          description:
            "Introdu data, ora și locul nașterii ca să deblochezi harta ta astrologică personalizată.",
        },
        {
          number: "02",
          icon: Bot,
        ...
        },
        {
          number: "03",
          icon: MessageSquare,
          title: "Întrebi și primești ghidaj",
          description:
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-[#F5F2FF] text-balance sm:text-4xl lg:text-5xl">
            {isRo ? "Trei pași spre" : "Three steps to"}{" "}
            <span className="text-gradient-cosmic">
              {isRo ? "claritate cosmică" : "cosmic clarity"}
            </span>
          </h2>
        </motion.div>
