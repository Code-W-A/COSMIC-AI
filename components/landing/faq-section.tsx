...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The Premium plan unlocks full AI chat access, complete birth chart interpretation, all specialized agents (love, career, daily guidance), and personalized daily cosmic messages. It removes the question limit from the free tier.",
  },
  {
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-[#F5F2FF] text-balance sm:text-4xl lg:text-5xl">
            Frequently asked{" "}
            <span className="text-gradient-cosmic">questions</span>
          </h2>
        </motion.div>
